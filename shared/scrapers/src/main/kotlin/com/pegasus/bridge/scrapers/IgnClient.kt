...
object IgnClient {
    ...
    internal var GQL = "https://mollusk.apis.ign.com/graphql"
    ...
    fun getImages(slug: String): Result<List<String>> {
        ...
        return HttpClient.get(url, HEADERS).mapCatching { body ->
            ...
            val imgs = resp
                ...
                ?.optJSONArray("images") ?: return@mapCatching emptyList()
